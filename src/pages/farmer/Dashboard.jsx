    ...
    <div className="mx-auto max-w-[1280px] px-4 py-5 sm:px-6 lg:px-7">
      ...
      <section className="mt-4">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          <button className="rounded-md bg-green-700 px-4 py-1.5 text-[9px] font-bold text-white hover:bg-green-800">
            Find Centres
          </button>

          <button className="rounded-md border border-green-200 bg-white px-4 py-1.5 text-[9px] font-bold text-slate-700 hover:bg-green-50">
            My Booking
          </button>
